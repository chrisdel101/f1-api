...
Revision ID: c5a95063d873
Revises: b43fca4c7f2f
Create Date: 2019-08-01 13:07:17.757372
...
revision = 'c5a95063d873'
down_revision = 'b43fca4c7f2f'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('points', sa.VARCHAR(length=25), autoincrement=False, nullable=True),
