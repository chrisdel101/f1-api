...
Revision ID: a90c85aa9694
Revises: e91fbeea3b48
Create Date: 2019-09-27 15:35:46.171194
...
revision = 'a90c85aa9694'
down_revision = 'e91fbeea3b48'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('test', sa.VARCHAR(length=1), autoincrement=False, nullable=True),
