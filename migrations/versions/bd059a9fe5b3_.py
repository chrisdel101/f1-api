...
Revision ID: bd059a9fe5b3
Revises: c78c496a603b
Create Date: 2019-07-30 16:07:56.949282
...
revision = 'bd059a9fe5b3'
down_revision = 'c78c496a603b'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('team_slug', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    ...
    sa.Column('fastest_lap', sa.VARCHAR(length=25), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='team_pkey'),
    sa.UniqueConstraint('full_team_name', name='team_full_team_name_key'),
    sa.UniqueConstraint('team_slug', name='team_team_slug_key')
    )
    # ### end Alembic commands ###
