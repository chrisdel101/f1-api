...
Revision ID: ec61cdba4b4c
Revises: 
Create Date: 2019-08-22 12:45:14.288003
...
def downgrade():
    ...
    sa.Column('name_slug', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    ...
    sa.Column('team_name_slug', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['team_name_slug'], ['team.id'], name='driver_team_name_slug_fkey'),
